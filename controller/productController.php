...
<?php
    class productController{
        ...
        public function update_product($data,$files,$id){
            ...
            $origin = mysqli_real_escape_string($this->db->link, $data['1']);
            $size = mysqli_real_escape_string($this->db->link, $data['2']);
            $productWeight = mysqli_real_escape_string($this->db->link, $data['3']);
            $material = mysqli_real_escape_string($this->db->link, $data['4']);
            $radiators = mysqli_real_escape_string($this->db->link, $data['5']);
            $cpu = mysqli_real_escape_string($this->db->link, $data['6']);
            $ram = mysqli_real_escape_string($this->db->link, $data['7']);
            $typeOfRam = mysqli_real_escape_string($this->db->link, $data['8']);
            $ramSpeed = mysqli_real_escape_string($this->db->link, $data['9']);
            $numberOfRamSlot = mysqli_real_escape_string($this->db->link, $data['10']);
            $maximumRamSupport = mysqli_real_escape_string($this->db->link, $data['11']);
            $screenSize = mysqli_real_escape_string($this->db->link, $data['12']);
            $resolution = mysqli_real_escape_string($this->db->link, $data['13']);
            $screenRatio = mysqli_real_escape_string($this->db->link, $data['14']);
            $onboardCard = mysqli_real_escape_string($this->db->link, $data['15']);
            $removableCard = mysqli_real_escape_string($this->db->link, $data['16']);
            $storage = mysqli_real_escape_string($this->db->link, $data['17']);
            $webCommunication = mysqli_real_escape_string($this->db->link, $data['18']);
            $wifi = mysqli_real_escape_string($this->db->link, $data['19']);
            $bluetooth = mysqli_real_escape_string($this->db->link, $data['20']);
            $camera = mysqli_real_escape_string($this->db->link, $data['21']);
            $keyboardType = mysqli_real_escape_string($this->db->link, $data['22']);
            $pin = mysqli_real_escape_string($this->db->link, $data['23']);
            $osVersion = mysqli_real_escape_string($this->db->link, $data['24']);
            $waterResistance = mysqli_real_escape_string($this->db->link, $data['25']);
            $internalMemory = mysqli_real_escape_string($this->db->link, $data['26']);
            $simType = mysqli_real_escape_string($this->db->link, $data['27']);
            $networkSupport = mysqli_real_escape_string($this->db->link, $data['28']);
            $get_origin_id = "SELECT id FROM tbl_specification WHERE name LIKE '%origin%'";
            $result_origin_id = $this->db->select($get_origin_id)->fetch_assoc();
            $originId = $result_origin_id['id'];
            $get_size_id = "SELECT id FROM tbl_specification WHERE name LIKE '%size%'";
